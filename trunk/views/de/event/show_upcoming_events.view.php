...
function display($result) {
	...
	if (isset($result['db_results'])) {
		print "<h1>Anstehende Veranstaltungen</h1>\n";

		print "<table class=\"db_display\">\n";
		print "<tr>\n";
		print "<th>Datum</th>\n";
		print "<th>Veranstaltungen</th>\n";
		print "<th>Sitzplätze</th>\n";
		...
		if (authAdmin()) {
			printf("<a class=\"button\" href=\"index.php?module=event&action=show_all_events\">Zeige alle Veranstaltungen</a>\n");
			printf("<a class=\"button\" href=\"index.php?module=event&action=add\">Füge Veranstaltung hinzu</a>\n");
		}
	}
